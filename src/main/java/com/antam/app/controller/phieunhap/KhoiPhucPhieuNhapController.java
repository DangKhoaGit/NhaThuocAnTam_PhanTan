    ...
    public KhoiPhucPhieuNhapController() {
        ...
        this.btnKhoiPhuc.setOnAction((e) -> {
            if (phieuNhapDTODuocChon == null){
                ...
                if (phieuNhap_DAO.suaTrangThaiPhieuNhap(phieuNhapDTODuocChon.getMaPhieuNhap())){
                ...
                phieuNhapDTODuocChon = null;
                tbPhieuNhap.refresh();
                ObservableList<PhieuNhapDTO> phieuNhapList = FXCollections.observableArrayList(phieuNhap_DAO.getDanhSachPhieuNhapTheoTrangThai(true));
