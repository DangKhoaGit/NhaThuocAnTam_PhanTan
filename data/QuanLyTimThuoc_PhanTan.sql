...
ADD CONSTRAINT UK_CTHD_MaHD_MaLT_TT UNIQUE (MaHD, MaLoThuoc, TinhTrang);
...
('KM005', 'Flash sale cuối tuần', '2025-03-05', '2025-12-31', 6, 50, 100),
('KM006', 'Combo 3 hộp giảm 15%', '2025-04-01', '2025-09-30', 7, 15, 100),
('KM007', 'Voucher 50k', '2025-01-20', '2025-07-20', 8, 5000, 100),
('KM008', 'Ưu đãi thành viên VIP', '2025-02-25', '2025-12-25', 9, 5, 500),
('KM009', 'Quà sinh nhật khách', '2025-01-01', '2025-12-31', 10, 10, 1000);

-- Thêm khuyến mãi mới từ 2026-04-21 đến 2026-12-31
INSERT INTO KhuyenMai (MaKM, TenKM, NgayBatDau, NgayKetThuc, LoaiKhuyenMai, So, SoLuongToiDa)
VALUES
('KM010', 'Giảm giá 15% cho tất cả sản phẩm', '2026-04-21', '2026-12-31', 1, 15, 500),
('KM011', 'Flash sale giảm 50% cuối tuần', '2026-04-21', '2026-12-31', 9, 50, 100),
('KM012', 'Mua 2 tặng 1 vitamin', '2026-04-21', '2026-12-31', 4, 10000, 150),
('KM013', 'Ưu đãi thành viên giảm 20%', '2026-04-21', '2026-12-31', 7, 20, 300);
...
('HD002',3,20,2, N'Bán', 70000),
('HD003',5,15,3, N'Bán', 75000),
('HD004',6,12,4, N'Bán', 30000),
('HD005',7,18,5, N'Bán', 153000),
('HD006',8,25,6, N'Bán', 212500),
('HD007',9,30,7, N'Bán', 195000),
('HD008',10,10,8, N'Bán', 25000),
('HD009',11,8,9, N'Bán', 17600),
('HD010',12,15,10, N'Bán', 45000);
